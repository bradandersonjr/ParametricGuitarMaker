...
export type IncomingAction = "PUSH_MODEL_STATE" | "PUSH_TEMPLATES" | "COMPUTING" | "response" | "PUSH_GROUP_STATES" | "TIMELINE_OPERATION_RESULT" | "HOLE_POSITION_RESULT" | "ZERO_FRET_RESULT" | "BLIND_FRETS_RESULT" | "RADIUS_MODE_RESULT" | "HEEL_CURVE_RESULT" | "PREFERENCES_LOADED" | "PREFERENCES_SAVED" | "PALETTE_RESHOWN" | "PUSH_THEME"
export type OutgoingAction = "ready" | "GET_MODEL_STATE" | "APPLY_PARAMS" | "cancel" | "OPEN_URL" | "GET_TEMPLATES" | "LOAD_TEMPLATE" | "IMPORT_SHARE" | "IMPORT_CSV" | "SAVE_TEMPLATE" | "DELETE_TEMPLATE" | "OPEN_TEMPLATES_FOLDER" | "GET_GROUP_STATES" | "APPLY_TIMELINE_CHANGES" | "SET_PARAM_CATEGORY" | "EDIT_PARAM" | "DELETE_PARAM" | "REMAP_HOLE_TO_SELECTION_SET" | "TOGGLE_ZERO_FRET" | "TOGGLE_BLIND_FRETS" | "SET_RADIUS_MODE" | "TOGGLE_HEEL_CURVE" | "GET_PREFERENCES" | "SAVE_PREFERENCES"
